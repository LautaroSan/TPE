...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-10-2021 a las 22:26:02
...
CREATE TABLE `aparatos` (
  ...
  `orden_olimpico` varchar(11) NOT NULL
...
(1, 'All-Around', '       Comprende los 6 aparatos individuales', ''),
